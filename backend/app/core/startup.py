...
from app.services.embedder import get_text_embedder, IMAGE_EMBED_ENABLED
...
async def initialize_services():
    try:
        ...
        if IMAGE_EMBED_ENABLED:
            logger.info("CLIP image embedding enabled but not available on this deployment.")
        else:
            logger.info("Image embedding disabled — using Groq vision fallback.")
